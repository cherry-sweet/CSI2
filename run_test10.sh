...
echo "正类: 2"
python eval.py --mode ood_pre --dataset cifar10 --model resnet18 --ood_score CSI --shift_trans_type rotation --print_score --ood_samples 10 --resize_factor 0.54 --resize_fix --one_class_idx 2 --load_path /home/xinghongjie/ping/CSI2/logs/cifar10_resnet18_unsup_simclr_CSI_shift_rotation_one_class_2/last.model --svdd_epochs 500 --batch_size 128&&
echo "正类: 3"
python eval.py --mode ood_pre --dataset cifar10 --model resnet18 --ood_score CSI --shift_trans_type rotation --print_score --ood_samples 10 --resize_factor 0.54 --resize_fix --one_class_idx 3 --load_path /home/xinghongjie/ping/CSI2/logs/cifar10_resnet18_unsup_simclr_CSI_shift_rotation_one_class_3/last.model --svdd_epochs 500 --batch_size 128&&
echo "正类: 4"
python eval.py --mode ood_pre --dataset cifar10 --model resnet18 --ood_score CSI --shift_trans_type rotation --print_score --ood_samples 10 --resize_factor 0.54 --resize_fix --one_class_idx 4 --load_path /home/xinghongjie/ping/CSI2/logs/cifar10_resnet18_unsup_simclr_CSI_shift_rotation_one_class_4/last.model --svdd_epochs 500 --batch_size 128&&
echo "正类: 5"
...
echo "正类: 7"
python eval.py --mode ood_pre --dataset cifar10 --model resnet18 --ood_score CSI --shift_trans_type rotation --print_score --ood_samples 10 --resize_factor 0.54 --resize_fix --one_class_idx 7 --load_path /home/xinghongjie/ping/CSI2/logs/cifar10_resnet18_unsup_simclr_CSI_shift_rotation_one_class_7/last.model --svdd_epochs 500 --batch_size 128&&
echo "正类: 8"
python eval.py --mode ood_pre --dataset cifar10 --model resnet18 --ood_score CSI --shift_trans_type rotation --print_score --ood_samples 10 --resize_factor 0.54 --resize_fix --one_class_idx 8 --load_path /home/xinghongjie/ping/CSI2/logs/cifar10_resnet18_unsup_simclr_CSI_shift_rotation_one_class_8/last.model --svdd_epochs 500 --batch_size 128&&
echo "正类: 9"
